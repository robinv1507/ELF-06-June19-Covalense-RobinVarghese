      ...
      <Table className={classes.table}>
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">DateOfBorrowed</StyledTableCell>
            <StyledTableCell align="right">DateOfReturn</StyledTableCell>
            
            <StyledTableCell align="right">requestDate</StyledTableCell>
            <StyledTableCell align="right">ReturnStatus</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map(row => (
